...
7. Set the Redirection URI as `<Cal.diy URL>/api/integrations/nextcloudtalk/callback` replacing [Cal.diy](https://cal.com) URL with the URI at which your application runs.
8. Click "Add".
