...
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Cally";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "help@cal.com";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Cally";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Cally";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Cally";
...
export const LOGO = "/cally-logo-word.svg";
export const LOGO_DARK = "/cally-logo-word.svg";
export const LOGO_ICON = "/cally-logo-icon.svg";
